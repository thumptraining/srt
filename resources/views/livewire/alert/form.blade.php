...
<!--Toast-->
<div class="alert-toast fixed bottom-10 right-0 m-8 w-5/6 md:w-full max-w-sm z-50">
    <input type="checkbox" class="hidden" id="footertoast">

    <label class="close cursor-pointer flex items-center justify-between w-full p-5 bg-primary h-20 rounded shadow-lg text-white" title="close" for="footertoast">
