...
class BeginnerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('beginners.index')
            ->with('success', 'Beginner created successfully.');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Beginner $beginner)
    {
        request()->validate(Beginner::$rules);
        ...
        return redirect()->route('beginners.index')
            ->with('success', 'Beginner updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('beginners.index')
            ->with('success', 'Beginner deleted successfully');
    }
}
